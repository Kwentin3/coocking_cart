...
- [Responsive chat layout blueprint](MVP_RESPONSIVE_CHAT_LAYOUT_BLUEPRINT_v0.1.md) - адаптивная модель chat/sessions/artifacts surfaces с layout math contract.
...
- [Gemini Live streaming voice research](MVP_GEMINI_LIVE_STREAMING_VOICE_RESEARCH_v0.1.md) - документальный домен и реализационный контур low-latency voice input через Gemini Live API и ephemeral tokens.
